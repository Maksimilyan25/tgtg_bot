...
import { getBrowserContext, ensureBrowserInitialized } from '../browser/browser.js';
...
function authMiddleware(req, res, next) {
    ...
    // Извлекаем user_id из заголовков для идентификации пользователя
    const userId = req.headers['x-user-id'] || req.headers['x-telegram-id'];
    if (userId) {
        req.userId = userId;
    }
